...
To create a menu, just create a `Menu` directory in a bundle, add a `Builder`
class, and then add a method that creates and returns your menu:
...
```jinja
{% set menuItem = knp_menu_get('AcmeDemoBundle:Builder:mainMenu', ['foo']) %}
